...
namespace strom {
    ...
    class Model {   ///begin_class_declaration
        ...
        public:
            ...
            typedef std::vector<QMatrix::SharedPtr>   state_freq_params_t;          ///!a
            ...
            typedef std::vector<ASRV::SharedPtr>      pinvar_params_t;              ///!b
    ...
    inline std::string Model::describeModel() { ///begin_describeModel
        ...
        for (unsigned i = 0; i < _num_subsets; i++) {
            ...
            if (f.second) {
                ...
                if (!_qmatrix[i]->isFixedStateFreqs())          ///!h
                    _state_freq_params.push_back(_qmatrix[i]);  ///!hh
            ...
            if (_subset_datatypes[i].isNucleotide()) {
                ...
                if (x.second) {
                    ...
                    if (!_qmatrix[i]->isFixedExchangeabilities())       ///!i
                        _exchangeability_params.push_back(_qmatrix[i]); ///!ii
            ...
            if (_subset_datatypes[i].isCodon()) {
                ...
                if (o.second) {
                    ...
                    if (!_qmatrix[i]->isFixedOmega())           ///!j
                        _omega_params.push_back(_qmatrix[i]);   ///!jj
            ...
            if (r.second) {
                ...
                if (!_asrv[i]->isFixedRateVar())            ///!k
                    _ratevar_params.push_back(_asrv[i]);    ///!kk
            ...
            if (_asrv[i]->getIsInvarModel()) {
                ...
                if (r.second) {
                    ...
                    if (!_asrv[i]->isFixedPinvar())         ///!l
                        _pinvar_params.push_back(_asrv[i]); ///!ll
