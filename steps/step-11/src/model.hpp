...
namespace strom {
    ...
    inline std::string Model::describeModel() { ///begin_describeModel
        ...
        for (unsigned i = 0; i < _num_subsets; i++) {
            ...
            // Determine whether exchangeabilities are unique for this subset   ///begin_uniq_xchg
    ...
    inline double Model::calcNormalizingConstantForSubsetRelRates() const { ///begin_calcNormalizingConstantForSubsetRelRates
    ...
    } ///end_calcNormalizingConstantForSubsetRelRates

    inline Model::subset_sizes_t & Model::getSubsetSizes() { ///begin_getSubsetSizes
        return _subset_sizes;
    }   ///end_getSubsetSizes
    
    inline void Model::setSubsetSizes(const subset_sizes_t nsites_vect) { ///begin_setSubsetSizes
    ...
    inline void Model::setSubsetNumPatterns(const subset_sizes_t npatterns_vect) { ///begin_setSubsetNumPatterns
    ...
    } ///end_setSubsetDataTypes

    inline void Model::setSubsetNumCateg(unsigned ncateg, unsigned subset) { ///begin_setSubsetNumCateg
        assert(subset < _num_subsets);
        if (ncateg < 1) {
    ...
    } ///end_setSubsetNumCateg
    
    inline void Model::setSubsetRateVar(ASRV::ratevar_ptr_t ratevar, unsigned subset, bool fixed) { ///begin_setSubsetRateVar
        assert(subset < _num_subsets);
        assert(ratevar);
        if (*ratevar < 0.0)
    ...
    } ///end_setSubsetRateVar
    
    inline void Model::setSubsetPinvar(ASRV::pinvar_ptr_t pinvar, unsigned subset, bool fixed) { ///begin_setSubsetPinvar
        assert(subset < _num_subsets);
        assert(pinvar);
        if (*pinvar < 0.0)
    ...
    inline void Model::setSubsetIsInvarModel(bool is_invar, unsigned subset) { ///begin_setSubsetIsInvarModel
        assert(subset < _num_subsets);
        _asrv[subset]->setIsInvarModel(is_invar);
    } ///end_setSubsetIsInvarModel
    
    inline void Model::setSubsetExchangeabilities(QMatrix::freq_xchg_ptr_t exchangeabilities, unsigned subset, bool fixed) { ///begin_setSubsetExchangeabilities
        assert(subset < _num_subsets);
    ...
    } ///end_setSubsetExchangeabilities
    
    inline void Model::setSubsetStateFreqs(QMatrix::freq_xchg_ptr_t state_frequencies, unsigned subset, bool fixed) { ///begin_setSubsetStateFreqs
        assert(subset < _num_subsets);
    ...
    } ///end_setSubsetStateFreqs
    
    inline void Model::setSubsetOmega(QMatrix::omega_ptr_t omega, unsigned subset, bool fixed) { ///begin_setSubsetOmega
        assert(subset < _num_subsets);
        assert(*omega > 0.0);
        if (_subset_datatypes[subset].isCodon()) {
    ...
    inline int Model::setBeagleEigenDecomposition(int beagle_instance, unsigned subset, unsigned instance_subset) { ///begin_setBeagleEigenDecomposition
        ...
        return code;
    } ///end_setBeagleEigenDecomposition
    
    inline int Model::setBeagleStateFrequencies(int beagle_instance, unsigned subset, unsigned instance_subset) { ///begin_setBeagleStateFrequencies
        assert(subset < _qmatrix.size());
        ...
        return code;
    } ///end_setBeagleStateFrequencies
    
    inline int Model::setBeagleAmongSiteRateVariationRates(int beagle_instance, unsigned subset, unsigned instance_subset) { ///begin_setBeagleAmongSiteRateVariationRates
        ...
        return code;
    } ///end_setBeagleAmongSiteRateVariationRates
    
    inline int Model::setBeagleAmongSiteRateVariationProbs(int beagle_instance, unsigned subset, unsigned instance_subset) { ///begin_setBeagleAmongSiteRateVariationProbs
        assert(subset < _asrv.size());
        ...
        return code;
    } ///end_setBeagleAmongSiteRateVariationProbs
